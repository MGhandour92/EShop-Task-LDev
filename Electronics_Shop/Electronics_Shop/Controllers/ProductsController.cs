...
namespace Electronics_Shop.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,UnitPrice,DisountToApply,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,UnitPrice,DisountToApply,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
